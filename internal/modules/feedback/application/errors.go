...
// IsDomainErr reports whether err (possibly wrapped) carries the given
// domain/app error code. Exported because command package reuse it.
func IsDomainErr(err error, code kernel.Code) bool {
	var ke *kernel.AppError
