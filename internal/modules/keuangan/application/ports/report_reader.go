...
type ReportReader interface {
	InvoiceSummary(ctx context.Context, billingPeriodID *string) ([]InvoiceSummaryReadModel, error)
	OutstandingBySantri(ctx context.Context, billingPeriodID *string, page, limit int) ([]OutstandingReadModel, int64, error)
